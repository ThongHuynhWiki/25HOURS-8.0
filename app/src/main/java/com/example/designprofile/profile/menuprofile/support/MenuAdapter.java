...
public class MenuAdapter extends RecyclerView.Adapter<MenuAdapter.ViewHolder>{
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_menu_supports,parent,false);
        ...
        if(data == null){
            ...
            holder.linItemMenu.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    menuInferface.onClickListener(holder.txtLabel, holder.relLine, positions);
                }
            });
    }
